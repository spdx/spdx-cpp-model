...
/* */
#ifndef _SHACL2CODE_SPDX_3_0_1_NAMEDINDIVIDUAL_HPP
#define _SHACL2CODE_SPDX_3_0_1_NAMEDINDIVIDUAL_HPP
...
public:
  /// Constructor
  NamedIndividual(TypeBase const *type, std::string &&iri, std::optional<std::string> &&compact);
   ...
   */
  std::optional<std::string> const &getCompactIRI() const { return mCompactIRI; }
...
private:
  ...
  LOCAL static NamedIndividual const *getFromMap(Map const &map, std::string const &key);
...
/* */
/* */
#endif // _SHACL2CODE_SPDX_3_0_1_NAMEDINDIVIDUAL_HPP
/* */
