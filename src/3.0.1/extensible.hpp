...
/* */
#ifndef _SHACL2CODE_SPDX_3_0_1_EXTENSIBLE_HPP
#define _SHACL2CODE_SPDX_3_0_1_EXTENSIBLE_HPP
 ...
 */
typedef std::variant<std::string, int, double, DateTime, Ref<SHACLObject>> Variant;
...
protected:
   ...
   */
  void encodeExtensibleProperties(ObjectEncoder &encoder, ErrorHandler &errorHandler,
   ...
   * @param path              The ObjectPath of the object
   */
  void decodeExtensibleProperty(std::string const &name, ValueDecoder &decoder,
...
private:
  ...
  LOCAL static void decodeExtPropertyValue(std::vector<Variant> &prop, ValueDecoder &decoder,
                                           ErrorHandler &errorHandler, ObjectPath &path);
};
 ...
 *      SHACL2CODE_SPDX_3_0_1_CLASS(MyExtensible, SHACLObject, false)
 *      public:
 *          // properties
 *  };
 * @endcode
 ...
 */
template <class T>
class SHACLExtensibleObject : public T, virtual private SHACLExtensibleObjectBase {
public:
  /// Destructor
  virtual ~SHACLExtensibleObject() {}

  /**
   * @copydoc ::SPDX::v3_0_1::SHACLExtensibleObjectBase::getExtProperty()
   */
  std::vector<Variant> &getExtProperty(std::string const &name) {
...
protected:
  /// @copydoc ::SPDX::v3_0_1::SHACLObject::encodeProperties()
  ...
  /// @copydoc ::SPDX::v3_0_1::SHACLObject::handleUnknownDecodeProperty()
  void handleUnknownDecodeProperty(std::string const &name, ValueDecoder &decoder,
                                   ErrorHandler &errorHandler, ObjectPath &path) override {
    if (this->getType().isExtensible()) {
  ...
  /// @copydoc ::SPDX::v3_0_1::SHACLObject::linkProperties()
  ...
  /// Constructor
  SHACLExtensibleObject(TypeBase const *type, SHACLObject::TypeIRIs const &typeIRIs)
...
/* */
/* */
#endif // _SHACL2CODE_SPDX_3_0_1_EXTENSIBLE_HPP
/* */
