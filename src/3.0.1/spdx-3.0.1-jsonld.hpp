...
// clang-format off
#ifndef _SHACL2CODE_SPDX_3_0_1_JSONLD_HPP
#define _SHACL2CODE_SPDX_3_0_1_JSONLD_HPP
// clang-format on
...
class EXPORT JSONLDValueEncoder : public ValueEncoder {
   public:
    ...
    /// @copydoc ::SPDX::v3_0_1::ValueEncoder::writeString()
    void writeString(std::string const& value) override;

    /// @copydoc ::SPDX::v3_0_1::ValueEncoder::writeDateTime()
    void writeDateTime(DateTime const& value) override;

    /// @copydoc ::SPDX::v3_0_1::ValueEncoder::writeInteger()
    void writeInteger(int value) override;

    /// @copydoc ::SPDX::v3_0_1::ValueEncoder::writeIRI()
    void writeIRI(std::string const& value,
                  std::optional<std::string> const& compact = {}) override;

    /// @copydoc ::SPDX::v3_0_1::ValueEncoder::writeEnum()
    void writeEnum(std::string const& value,
                   std::optional<std::string> const& compact = {}) override;

    /// @copydoc ::SPDX::v3_0_1::ValueEncoder::writeBool()
    void writeBool(bool value) override;

    /// @copydoc ::SPDX::v3_0_1::ValueEncoder::writeFloat()
    void writeFloat(double value) override;

    /// @copydoc ::SPDX::v3_0_1::ValueEncoder::writeDict()
    void writeDict(std::function<void(ObjectEncoder&)> const& f) override;

    /// @copydoc ::SPDX::v3_0_1::ValueEncoder::writeObject()
    ...
    /// @copydoc ::SPDX::v3_0_1::ValueEncoder::writeList()
...
class EXPORT JSONLDObjectEncoder : public ObjectEncoder {
   public:
    ...
    /// @copydoc ::SPDX::v3_0_1::ObjectEncoder::writeProperty()
...
class EXPORT JSONLDListEncoder : public ListEncoder {
   public:
    ...
    /// @copydoc ::SPDX::v3_0_1::ListEncoder::writeItem()
...
class EXPORT JSONLDValueDecoder : public ValueDecoder {
   public:
    ...
    /// @copydoc ::SPDX::v3_0_1::ValueDecoder::getType()
    ValueDecoder::Type getType() const override;

    /// @copydoc ::SPDX::v3_0_1::ValueDecoder::readString()
    std::optional<std::string> readString() override;

    /// @copydoc ::SPDX::v3_0_1::ValueDecoder::readDateTime()
    std::optional<DateTime> readDateTime() override;

    /// @copydoc ::SPDX::v3_0_1::ValueDecoder::readDateTimeStamp()
    std::optional<DateTime> readDateTimeStamp() override;

    /// @copydoc ::SPDX::v3_0_1::ValueDecoder::readInteger()
    std::optional<int> readInteger() override;

    /// @copydoc ::SPDX::v3_0_1::ValueDecoder::readIRI()
    std::optional<std::string> readIRI() override;

    /// @copydoc ::SPDX::v3_0_1::ValueDecoder::readEnum()
    std::optional<std::string> readEnum() override;

    /// @copydoc ::SPDX::v3_0_1::ValueDecoder::readBool()
    std::optional<bool> readBool() override;

    /// @copydoc ::SPDX::v3_0_1::ValueDecoder::readFloat()
    std::optional<double> readFloat() override;

    /// @copydoc ::SPDX::v3_0_1::ValueDecoder::readObject()
    bool readObject(std::function<void(ObjectDecoder&)> const& f) override;

    /// @copydoc ::SPDX::v3_0_1::ValueDecoder::readList()
...
class EXPORT JSONLDObjectDecoder : public ObjectDecoder {
   public:
    ...
    /// @copydoc ::SPDX::v3_0_1::ObjectDecoder::readType()
    std::optional<std::string> readType() override;

    /// @copydoc ::SPDX::v3_0_1::ObjectDecoder::readProperties()
...
class EXPORT JSONLDListDecoder : public ListDecoder {
   public:
    ...
    /// @copydoc ::SPDX::v3_0_1::ListDecoder::readItems()
...
#endif  // _SHACL2CODE_SPDX_3_0_1_JSONLD_HPP
