...
/* */
#ifndef _SHACL2CODE_SPDX_3_0_1_EXCEPTIONS_HPP
#define _SHACL2CODE_SPDX_3_0_1_EXCEPTIONS_HPP
...
public:
  ...
  PathError(std::string const &message, std::string const &path)
      : mMessage(message), mPath(path), mWhat(path + std::string(": ") + message) {}
...
public:
   ...
   */
  ValidationError(std::string const &message, std::string const &path) : PathError(message, path) {}
};
...
/* */
/* */
#endif // _SHACL2CODE_SPDX_3_0_1_EXCEPTIONS_HPP
/* */
