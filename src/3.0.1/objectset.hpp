...
/* */
#ifndef _SHACL2CODE_SPDX_3_0_1_OBJECTSET_HPP
#define _SHACL2CODE_SPDX_3_0_1_OBJECTSET_HPP
...
public:
   ...
   */
  void decode(ListDecoder &decoder, ErrorHandler &errorHandler, ObjectPath &path);
   ...
   */
  void decode(ObjectDecoder &decoder, ErrorHandler &errorHandler, ObjectPath &path);
   ...
   * @brief Add context
   *
   * Adds a new context entry to the context for this ObjectSet
   *
   * @param prefix    The context prefix to add
   * @param expanded  The expanded value that maps to the prefix
   */
  void addContext(std::string const &prefix, std::string const &expanded);

  /**
   * @brief Expand IRI
   *
   * Expands an IRI using the context of the ObjectSet
   *
   * @param iri   The IRI to expand
   *
   * @returns the expanded form of the IRI
   */
   ...
   * @brief Compact IRI
   *
   * Compacts an IRI using the context of the ObjectSet
   *
   * @param iri   The IRI to compact
   *
   * @returns the compacted form of the IRI
   */
   ...
   * @brief Get context
   *
   * @returns the context of the ObjectSet
   */
...
private:
  ...
  LOCAL void decodeObject(ObjectDecoder &decoder, ErrorHandler &errorHandler, ObjectPath &path);
};
...
/* */
/* */
#endif // _SHACL2CODE_SPDX_3_0_1_OBJECTSET_HPP
/* */
