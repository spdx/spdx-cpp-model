...
/* */
#ifndef _SHACL2CODE_SPDX_3_0_1_DATETIME_HPP
#define _SHACL2CODE_SPDX_3_0_1_DATETIME_HPP
...
public:
   ...
   */
  static std::optional<DateTime> fromString(std::string const &s, bool tzRequired);
 ...
 */
extern EXPORT std::ostream &operator<<(std::ostream &stream, DateTime const &datetime);
...
/* */
/* */
#endif // _SHACL2CODE_SPDX_3_0_1_DATETIME_HPP
/* */
