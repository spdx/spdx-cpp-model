...
/* */
#ifndef _SHACL2CODE_SPDX_3_0_1_OBJECTPATH_HPP
#define _SHACL2CODE_SPDX_3_0_1_OBJECTPATH_HPP
...
public:
   ...
   */
  template <class C, class T> void foreachItem(C const &c, T const &f) {
    int i = 0;
    for (auto const &v : c) {
      pushIndex(i, [&] { f(v); });
      i++;
   ...
   */
  template <class I, class T> void foreachItem(I start, I end, T const &f, int idxStart = 0) {
    int i = idxStart;
   ...
   */
  void foreachListDecoder(ListDecoder &decoder, std::function<void(ValueDecoder &)> const &f);
...
/* */
/* */
#endif // _SHACL2CODE_SPDX_3_0_1_OBJECTPATH_HPP
/* */
