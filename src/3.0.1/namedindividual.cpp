...
NamedIndividual const *NamedIndividual::getFromMap(NamedIndividual::Map const &map,
...
NamedIndividual const *NamedIndividual::getFromCompact(std::string const &compact) {
