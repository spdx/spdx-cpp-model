...
/* */
#ifndef _SHACL2CODE_SPDX_3_0_1_DECODE_HPP
#define _SHACL2CODE_SPDX_3_0_1_DECODE_HPP
...
public:
   ...
   */
  virtual void
  readProperties(std::function<void(std::string const &, ValueDecoder &)> const &f) = 0;
};
...
/* */
/* */
#endif // _SHACL2CODE_SPDX_3_0_1_DECODE_HPP
/* */
