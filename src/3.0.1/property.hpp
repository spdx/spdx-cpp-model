...
/* */
#ifndef _SHACL2CODE_SPDX_3_0_1_PROPERTY_HPP
#define _SHACL2CODE_SPDX_3_0_1_PROPERTY_HPP
...
public:
   ...
   * @param[in] dflt  The value to return if no compaction occurs
   *
   ...
   */
  std::optional<std::string> compactValue(std::string const &value,
   ...
   *                  IRI
   * @param[in] dflt  The value to return if no expansion occurs
   *
   ...
   */
  std::optional<std::string> expandValue(std::string const &value,
                                         std::optional<std::string> const &dflt = {}) const;
...
protected:
   ...
   */
  bool checkDecodeString(ValueDecoder &decoder, ErrorHandler &errorHandler, ObjectPath &path) const;
   ...
   */
  bool validateString(std::string const &value, ErrorHandler &errorHandler, ObjectPath &path) const;
 ...
 */
template <typename C> class Property : public PropertyContext, public RegexProperty {
public:
  /// Constructor
  Property(std::optional<std::regex> &&regex = {}, PropertyContext::Context &&context = {})
      : PropertyContext(std::move(context)), RegexProperty(std::move(regex)) {}
   ...
   */
  virtual bool validateValue(C const &value, ErrorHandler &errorHandler, ObjectPath &path) const {
   ...
   * @param path              The ObjectPath of the value
   */
  virtual void encode(ValueEncoder &encoder, C const &value, ErrorHandler &errorHandler,
   ...
   */
  virtual std::optional<C> decode(ValueDecoder &decoder, ErrorHandler &errorHandler,
                                  ObjectPath &path) const = 0;
   ...
   */
  virtual void walk(WalkCallback const &callback,
...
public:
  /// Constructor
  StringProperty(std::optional<std::regex> &&regex = {}, PropertyContext::Context &&context = {});

  /// Destructor
  virtual ~StringProperty();

  /// @copydoc ::SPDX::v3_0_1::Property::validateValue()
  bool validateValue(std::string const &value, ErrorHandler &errorHandler,
                     ObjectPath &path) const override;

  /// @copydoc ::SPDX::v3_0_1::Property::toString()
  std::string toString(std::string const &value) const override;

  /// @copydoc ::SPDX::v3_0_1::Property::encode()
  void encode(ValueEncoder &encoder, std::string const &value, ErrorHandler &errorHandler,
              ObjectPath &path) const override;

  /// @copydoc ::SPDX::v3_0_1::Property::decode()
  std::optional<std::string> decode(ValueDecoder &decoder, ErrorHandler &errorHandler,
                                    ObjectPath &path) const override;

  /// @copydoc ::SPDX::v3_0_1::Property::walk()
...
public:
  /// Constructor
  IntegerProperty(std::optional<std::regex> &&regex = {}, std::optional<int> &&min = {},
  ...
  /// @copydoc ::SPDX::v3_0_1::Property::validateValue()
  bool validateValue(int const &value, ErrorHandler &errorHandler, ObjectPath &path) const override;

  /// @copydoc ::SPDX::v3_0_1::Property::toString()
  std::string toString(int const &value) const override;

  /// @copydoc ::SPDX::v3_0_1::Property::encode()
  void encode(ValueEncoder &encoder, int const &value, ErrorHandler &errorHandler,
              ObjectPath &path) const override;
...
public:
  ...
  /// @copydoc ::SPDX::v3_0_1::Property::encode()
  void encode(ValueEncoder &encoder, bool const &value, ErrorHandler &errorHandler,
              ObjectPath &path) const override;

  /// @copydoc ::SPDX::v3_0_1::Property::decode()
  std::optional<bool> decode(ValueDecoder &decoder, ErrorHandler &errorHandler,
                             ObjectPath &path) const override;
...
public:
  /// Constructor
  DoubleProperty(std::optional<std::regex> &&regex = {}, std::optional<double> &&min = {},
  ...
  /// @copydoc ::SPDX::v3_0_1::Property::encode()
  void encode(ValueEncoder &encoder, double const &value, ErrorHandler &errorHandler,
              ObjectPath &path) const override;

  /// @copydoc ::SPDX::v3_0_1::Property::decode()
  std::optional<double> decode(ValueDecoder &decoder, ErrorHandler &errorHandler,
                               ObjectPath &path) const override;
...
public:
  ...
  /// @copydoc ::SPDX::v3_0_1::Property::encode()
  void encode(ValueEncoder &encoder, DateTime const &value, ErrorHandler &errorHandler,
              ObjectPath &path) const override;

  /// @copydoc ::SPDX::v3_0_1::Property::decode()
  std::optional<DateTime> decode(ValueDecoder &decoder, ErrorHandler &errorHandler,
                                 ObjectPath &path) const override;
...
/* */
/* */
#endif // _SHACL2CODE_SPDX_3_0_1_PROPERTY_HPP
/* */
