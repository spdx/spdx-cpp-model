...
/* */
#ifndef _SHACL2CODE_SPDX_3_0_1_OBJECT_HPP
#define _SHACL2CODE_SPDX_3_0_1_OBJECT_HPP
...
public:
  ...
  using TypeIRIs = std::optional<std::pair<std::string, std::optional<std::string>>>;
   ...
   * @param path              The ObjectPath of the object
   */
  void encode(ValueEncoder &encoder, ErrorHandler &errorHandler, ObjectPath &path) const;
   ...
   * be decoded
   */
  static std::shared_ptr<SHACLObject> decode(ObjectDecoder &decoder, TypeBase const *type,
   ...
   * @endcode
   */
  template <auto P, typename T> auto &set(T const &value) { return setHelper<P>(*this, value); }
   ...
   * @endcode
   */
  template <auto P, typename T> auto &add(T const &value) { return addHelper<P>(*this, value); }
...
protected:
   ...
   * @param path              The ObjectPath of the object
   */
  virtual void encodeProperties(ObjectEncoder &encoder, ErrorHandler &errorHandler,
   ...
   * ::SPDX::v3_0_1::ErrorHandler::handleDeserializeError on @p errorHandler
   *
   ...
   * @param path              The ObjectPath of the object
   */
  virtual void handleUnknownDecodeProperty(std::string const &name, ValueDecoder &decoder,
                                           ErrorHandler &errorHandler, ObjectPath &path);

  /// @copydoc ::SPDX::v3_0_1::SHACLObject::link()
...
private:
  ...
  LOCAL static std::unordered_map<std::string, TypeBase const *> &getIRITypeRegistry();

  LOCAL static std::unordered_map<std::string, TypeBase const *> &getCompactTypeRegistry();

  // PropertyValueCommon can register new properties
  friend PropertyValueCommon::PropertyValueCommon(SHACLObject *owner, std::string const &iri,
...
/* */
/* */
#endif // _SHACL2CODE_SPDX_3_0_1_OBJECT_HPP
/* */
