...
/* */
#ifndef _SHACL2CODE_SPDX_3_0_1_ENCODE_HPP
#define _SHACL2CODE_SPDX_3_0_1_ENCODE_HPP
...
public:
   ...
   */
  std::set<std::shared_ptr<SHACLObject>> const &getRefed() const { return mRefed; }
...
public:
   ...
   * @see ObjectEncoder
   */
  virtual void writeObject(SHACLObject const &o, std::string const &type, std::string const &id,
                           bool needs_id, std::function<void(ObjectEncoder &)> const &f) = 0;
...
public:
   ...
   */
  virtual void writeProperty(std::string const &iri, std::optional<std::string> const &compact,
...
/* */
/* */
#endif // _SHACL2CODE_SPDX_3_0_1_ENCODE_HPP
/* */
