...
/* */
#ifndef _SHACL2CODE_SPDX_3_0_1_PROP_HPP
#define _SHACL2CODE_SPDX_3_0_1_PROP_HPP
 ...
 *      SHACL2CODE_SPDX_3_0_1_CLASS(MyClass, SHACLObject, false)
 *      public:
 ...
 *
 * @see ::SPDX::v3_0_1::Prop
 * @see ::SPDX::v3_0_1::DateTime
 */
// clang-format off
using DateTime = PropertyValue <::SPDX::v3_0_1::DateTime, DateTimeProperty>;
// clang-format on
 ...
 */
// clang-format off
using DateTimeStamp = PropertyValue <::SPDX::v3_0_1::DateTime, DateTimeStampProperty>;
// clang-format on
 ...
 * @see ::SPDX::v3_0_1::Ref
 */
template <class C> using Ref = RefPropertyValue<C>;
 ...
 */
// clang-format off
using DateTimeList = ListPropertyValue<::SPDX::v3_0_1::DateTime, DateTimeProperty>;
 ...
 * @see ::SPDX::v3_0_1::DateTime
 */
using DateTimeStampList = ListPropertyValue<::SPDX::v3_0_1::DateTime, DateTimeStampProperty>;
// clang-format on
 ...
 * @see ::SPDX::v3_0_1::Ref
 */
template <class C> using RefList = RefListPropertyValue<C>;
// clang-format on
} // namespace Prop
...
/* */
/* */
#endif // _SHACL2CODE_SPDX_3_0_1_PROP_HPP
/* */
