...
/* */
#ifndef _SHACL2CODE_SPDX_3_0_1_ERRORHANDLER_HPP
#define _SHACL2CODE_SPDX_3_0_1_ERRORHANDLER_HPP
...
public:
   ...
   */
  virtual void handleValidationError(std::string const &message, ObjectPath const &path) = 0;
   ...
   * @param[in] path      The ObjectPath of the item that caused the error
   */
  virtual void handleDeserializeError(std::string const &message, ObjectPath const &path) = 0;
};
...
public:
  ...
  /**
   * @copydoc ::SPDX::v3_0_1::ErrorHandler::handleValidationError
   *
   * @throws ValidationError to report the error
   */
  void handleValidationError(std::string const &message, ObjectPath const &path) override;

  /**
   * @copydoc ::SPDX::v3_0_1::ErrorHandler::handleDeserializeError
   *
   * @throws DeserializeError to report the error
   */
  void handleDeserializeError(std::string const &message, ObjectPath const &path) override;
...
/* */
/* */
#endif // _SHACL2CODE_SPDX_3_0_1_ERRORHANDLER_HPP
/* */
