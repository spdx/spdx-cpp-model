...
/* */
#ifndef _SHACL2CODE_SPDX_3_0_1_TYPE_HPP
#define _SHACL2CODE_SPDX_3_0_1_TYPE_HPP
...
template <class T> class SHACLExtensibleObject;
...
public:
  /// Constructor
  TypeBase(std::string &&typeIRI, std::optional<std::string> &&compactTypeIRI);
...
protected:
   ...
   */
  std::optional<std::string> const &getCompactTypeIRI() const { return mCompactTypeIRI; }
   ...
   */
  virtual std::shared_ptr<SHACLObject> createExtensible(std::string const &typeIRI) const = 0;
 ...
 * SHACL2CODE_SPDX_3_0_1_CLASS macro takes care of it
 *
 ...
 */
template <class C, class PARENT, bool ABSTRACT> class SHACLType : public TypeBase {
private:
...
public:
  /// Constructor
  SHACLType(std::string &&typeIRI, std::optional<std::string> &&compactTypeIRI,
            std::optional<std::string> &&IDAlias, std::optional<NodeKind> &&nodeKind,
            std::optional<bool> &&isExtensible)
      : TypeBase(std::move(typeIRI), std::move(compactTypeIRI)), mIDAlias(std::move(IDAlias)),
        mNodeKind(std::move(nodeKind)), mIsExtensible(std::move(isExtensible)) {}

  /// Destructor
  virtual ~SHACLType() {}

  /// @copydoc ::SPDX::v3_0_1::TypeBase::getIDAlias()
  ...
  /// @copydoc ::SPDX::v3_0_1::TypeBase::getNodeKind()
  ...
  /// @copydoc ::SPDX::v3_0_1::TypeBase::isExtensible()
  ...
  /// @copydoc ::SPDX::v3_0_1::TypeBase::isAbstract()
  bool isAbstract() const override { return ABSTRACT; }

  /// @copydoc ::SPDX::v3_0_1::TypeBase::isSubClassOf()
...
protected:
  /// @copydoc ::SPDX::v3_0_1::TypeBase::create()
  ...
  /// @copydoc ::SPDX::v3_0_1::TypeBase::createExtensible()
  std::shared_ptr<SHACLObject> createExtensible(std::string const &typeIRI) const override {
    ...
    return std::shared_ptr<C>(
        new C(std::optional<std::pair<std::string, std::optional<std::string>>>({typeIRI, {}})));
  }
...
/* */
/* */
#endif // _SHACL2CODE_SPDX_3_0_1_TYPE_HPP
/* */
